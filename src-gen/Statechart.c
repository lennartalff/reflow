...
static void swap_in_events(Statechart* handle)
{
	...
	handle->current.timeEvents.Statechart_main_region_Operating_r1_HeatRamp_time_event_1_raised = handle->timeEvents.statechart_main_region_Operating_r1_HeatRamp_tev1_raised;
	handle->timeEvents.statechart_main_region_Operating_r1_HeatRamp_tev1_raised = bool_false;
}
...
static void enact_main_region_Operating_r1_HeatRamp(Statechart* handle)
{
	...
	statechart_set_timer(handle, (sc_eventid) &(handle->timeEvents.statechart_main_region_Operating_r1_HeatRamp_tev1_raised) , 2000, bool_true);
...
static void exact_main_region_Operating_r1_HeatRamp(Statechart* handle)
{
	...
	statechart_unset_timer(handle, (sc_eventid) &(handle->timeEvents.statechart_main_region_Operating_r1_HeatRamp_tev1_raised) );		
}
...
static sc_integer main_region_Operating_r1_HeatRamp_react(Statechart* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		if (handle->current.timeEvents.Statechart_main_region_Operating_r1_HeatRamp_time_event_1_raised == bool_true)
		{ 
			handle->ifaceLearn.total_time += 2;
		} 
		transitioned_after = main_region_Operating_react(handle, transitioned_before);
	} return transitioned_after;
}
